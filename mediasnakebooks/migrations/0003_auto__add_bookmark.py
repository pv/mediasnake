...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'mediasnakebooks_bookmark', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ebook', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mediasnakebooks.Ebook'], unique=True)),
            ('chapter', self.gf('django.db.models.fields.IntegerField')()),
            ('paragraph', self.gf('django.db.models.fields.IntegerField')()),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'mediasnakebooks', ['Bookmark'])


    def backwards(self, orm):
        # Deleting model 'Bookmark'
        db.delete_table(u'mediasnakebooks_bookmark')
