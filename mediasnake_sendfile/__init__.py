...
def sendfile(request, filename, attachment=False, attachment_filename=None, mimetype=None, encoding=None,
    ...
    If accept_ranges is True, the Accept-Ranges HTTP header will is
    enabled in the response. This also enables the range request
    support in the sendfile.backends.simple backend.
    '''
